    ...
    IStringLocalizer<Messages> localizer) : IToolCallDispatcher
{
        ...
        try
        {
            ...
            var result = toolCall.Name switch
            {
                ...
                "add_to_cart" => await toolExecutor.AddToCartAsync(
                    ...
                    int.TryParse(GetArg(toolCall.Arguments, "quantity"), out var q) ? q : 1,
                    ct),
    ...
    public List<(string Key, string Label, string Icon, List<FunctionCallContent> Tools)> GroupConsecutiveToolCalls(
