...
public class GetRecipesForMealsActionTests
{
    ...
    public void GetRecipesForMeals()
    {
        ...
        var meal1 = new Meal(new DateTime(), mealType, new Recipe("Recipe 1", 3, 2, Array.Empty<Ingredient>()), 2);
        var meal2 = new Meal(new DateTime(), mealType, new Recipe("Recipe 2", 3, 2, Array.Empty<Ingredient>()), 2);
