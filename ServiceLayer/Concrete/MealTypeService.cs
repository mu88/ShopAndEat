...
{
    public ExistingMealTypeDto CreateMealType(NewMealTypeDto newArticleGroupDto) => simpleCrudHelper.Create<NewMealTypeDto, MealType, ExistingMealTypeDto>(newArticleGroupDto);
